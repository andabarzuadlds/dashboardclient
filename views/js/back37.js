window.addEventListener('load', function() {
    ...
    // Ejecutar la función después de 1 segundo
    setTimeout(actualizarKPIConTotalPedidos3, 1000);
    ...
    // Ejecutar la función después de 1 segundo
    setTimeout(actualizarKPIClientes1, 1000); // Cambiado a 1000 para esperar 1 segundo
    ...
    fetch('https://dlds.cl/obtenerPedidos/obtenerClientes2.php')
        ...
        // Ejecutar la función después de 1 segundo
        setTimeout(actualizarKPIClientes2, 1000); // Cambiado a 1000 para esperar 1 segundo
        ...
        fetch('https://dlds.cl/obtenerPedidos/obtenerClientes3.php')
            ...
            // Ejecutar la función después de 1 segundo
            setTimeout(actualizarKPIClientes3, 1000); // Cambiado a 1000 para esperar 1 segundo
            ...
            fetch('https://dlds.cl/obtenerPedidos/obtenerClientes4.php')
                ...
                // Ejecutar la función después de 1 segundo
                setTimeout(actualizarKPIClientes4, 1000); // Cambiado a 1000 para esperar 1 segundo
                ...
                fetch('https://dlds.cl/obtenerPedidos/obtenerClientes6.php')
                    ...
                    // Ejecutar la función después de 1 segundo
                    setTimeout(actualizarKPIClientes6, 600);
